package endow_ja.handytool.Helper.screenshot;
...
import endow_ja.handytool.Helper.screenshot.android.support.v4.os.AsyncTaskCompat;
...
public class Shotter {
    ...
    public void startScreenShot(OnShotListener onShotListener, Context context) {
